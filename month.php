        ...
        <div class="main-wrapper">
            ...
            <div class="content-wrapper">
             ...
             <div class="col-md-12">
                                 ...
                                 <div class="col-md-6">
                                 <label>Month</label>
                                 <select name="monthpicker"class="form-control">
                                 ...
                                 <div class="col-md-8 col-md-offset-2" style="margin-top:10px;margin-bottom:14px;">
                                     <button name='monreport'class='btn btn-success'>SUBMIT</button>
                                 </div>
                             </div>
             </form>
        <br />
               ...
               for (i = new Date().getFullYear(); i > 1900; i--)
{
    $('#yearpicker').append($('<option />').val(i).html(i));
                ...
                toastr["success"]( "Select Date and Month to Load results of that Month
                ");
