...
echo'<table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">';
  echo '<thead>';
    echo '<tr>';
      ...
      echo '<th>Amount Spent(Per kg)</th>';
      echo '<th>Date Bought</th>';
    echo '</tr>';
  echo '</thead>';
  echo '<tbody>';
$total_pages_sql = "SELECT COUNT(*) FROM purchases";
$result = mysqli_query($conn,$total_pages_sql);
$total_rows = mysqli_fetch_array($result)[0];
$total_pages = ceil($total_rows / $no_of_records_per_page);

$sql = "SELECT * FROM purchases ORDER BY purchase_date ASC LIMIT $offset, $no_of_records_per_page";
