       ...
       <div class="col-md-12">
           ...
           //get the page's url
            ...
            <div class="col-md-10 col-md-offset-1">
              <a  href="lateentries.php"><button class="btn btn-primary">ENTER LATE ENTRIES</button></a>
           </div>
                <form action="dailysales.php" method="POST" class="form-group"><br>
                   <div class="col-md-10 col-md-offset-1">
                       <h3>Register sales here:</h3>
                   </div>
                   <div class="col-md-10 col-md-offset-1">
                   ...
                   <div class="col-md-8 col-md-offset-2" style="margin-bottom:23px;">
                        <button class="btn btn-primary" type="submit" name="sale">SUBMIT</button>
                   </div>
                </form><br><br><br><br>
                
                <div class="panel-body p-20 col-md-10 col-md-offset-1" >
                <h3 >TODAY'S SALES</h3><br>
              <?php
              require 'includes/config.php';
...
<script src="js/jquery/jquery-2.2.4.min.js"></script>
  ...
  <script>
    $(function(){
                ...
                toastr["success"]( "Welcome to the salesPoint!");
