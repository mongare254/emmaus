...
<body class="top-navbar-fixed">
  ...
  //get the page's url
            ...
            ?>
                 <h3>Expenses are recorded here..</h3>
                 <div class="pagecontente">
                 <form class="form-group" method="POST" action='exphandler.php'>
                   <div class="placeholders">
                     <div class="col-md-8">
                       <label>EXPENSE NAME:</label>
                       <input type="text"  name="exname" placeholder="Enter Expense Name "class="form-control" required>
                     ...
                     <div class="col-md-6 col-md-offset-3">
                       <button class="btn btn-primary" type="submit" name="exitem">SUBMIT</button>
                     </div>
                   </div>
                 </form>
               </div>
